          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex items-center mt-8">
                <div className="bg-turf-100 p-3 rounded-full">
                  <Trophy className="w-8 h-8 text-turf-600" />
                </div>
                <div className="ml-4">
                  <h3 className="font-semibold text-gray-800">Excellence in Service</h3>
                  <p className="text-gray-600">Committed to providing exceptional booking experiences</p>
                </div>
              </div>
            </motion.div>
          ...
          >
            {[
              ...
              <motion.div 
                ...
                variants={fadeIn}
              >
                <div className="bg-turf-100 p-3 rounded-full inline-block mb-4">
                  <div className="text-turf-600">
                    {value.icon}
                  </div>
                </div>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                <img 
                  src={member.image} 
                  alt={member.name} 
                  className="w-24 h-24 rounded-full mx-auto mb-4 border-4 border-turf-100"
                />
                <h3 className="text-xl font-semibold mb-1">{member.name}</h3>
                <p className="text-turf-600 mb-3">{member.role}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="flex items-center mb-6">
                <MapPin className="w-8 h-8 text-turf-400 mr-3" />
